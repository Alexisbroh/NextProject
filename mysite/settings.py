...
SECRET_KEY = 'django-insecure-ni@w-nhg0e7=2sm2st%exq=@^ceo$mtpc2y&lnvja0w9*$(v_='
...
# here we start to installed and called the API 
INSTALLED_APPS = [
    ...
    'allauth',                              #with all auth we are ausing for authenticate 
